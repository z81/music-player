	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			...
			value: function render() {
				...
				var music = '';
				var pauseClass = this.state.isPlay ? { "btn": true } : { "btn": true, pause: true };
				...
				if (this.state.music !== []) {
					music = _react2['default'].createElement(
						...
						this.state.music.map(function (t) {
							...
							return _react2['default'].createElement(_materialUi.ListItem, { primaryText: t.title, secondaryText: t.artist[0], secondaryTextLines: 1, onClick: selectTrack });
						})
					);
				}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ id: 'player-controls' },
							_react2['default'].createElement('audio', { id: 'audio', src: this.state.track }),
							_react2['default'].createElement('span', { id: 'prev', className: 'btn' }),
							_react2['default'].createElement('span', { id: 'play', className: { pauseClass: pauseClass }, onClick: this.play.bind(this) }),
