	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
	      ...
	      return {
			...
			value: function changeVolumeStart() {
				this.setState(function (e) {
					volume_start: e.clientY;
				});
			}
		}, {
			key: 'changeVolumeStop',
			value: function changeVolumeStop() {
				console.log(this.satte.volume_start - e.clientY);
			}
		}, {
			key: 'render',
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						this.state.music.map(function (t, i) {
							var selectedClass = i === _this6.state.track ? "track current_selected" : "track";
							...
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									{ id: 'volume-level',
										...
										onMouseDown: this.state.changeVolumeStart.bind(this),
										onMouseUp: this.state.changeVolumeStop.bind(this)
									},
