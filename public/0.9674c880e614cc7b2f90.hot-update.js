	...
	var Element = (function (_React$Component) {
	   ...
	   */
			...
			value: function changeVolumeMove(e) {
				console.log(JSON.parse(this.state.volume_start));
				/*if(window.isVolumeChange) {
	   	this.setState(()=> {
	   		return {
	   			volume: this.state.volume + (window.volume_start - e.clientY)
	   		}
	   	})
	   }*/
			}
