...
/***/ function(module, exports, __webpack_require__) {
	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			key: 'componentDidnMount',
			value: function componentDidnMount() {
				this.getMusic();
			}
		}, {
			key: 'getMusic',
			...
			value: function render() {
				...
				if (this.state.music) {
					music = _react2['default'].createElement(
						_materialUi.List,
						{ subheader: 'Музыка' },
						this.state.music.map(function () {
							return _react2['default'].createElement(_materialUi.ListItem, { primaryText: 'Brendan Lim', secondaryText: "text", secondaryTextLines: 2 });
						})
					);
				}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'span',
							null,
							_react2['default'].createElement('div', { id: 'player-time' })
						),
						_react2['default'].createElement(
							'div',
							{ id: 'player-controls' },
