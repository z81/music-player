	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			...
			value: function prev() {
				...
				this.setState(function () {
					return {
						track: _this4.state.track > 1 ? _this4.state.track - 1 : _this4.state.music.length - 1
					};
				});
			}
		}, {
			...
			value: function next() {
				...
				this.setState(function () {
					return {
						track: _this5.state.track < _this5.state.music.length - 1 ? _this5.state.track + 1 : 0
					};
				});
			}
		}, {
			...
			value: function changeVolume(e) {
				...
				this.setState(function () {
					_this6.state.audio.volume = volume;
					return {
						volume: volume
					};
				});
