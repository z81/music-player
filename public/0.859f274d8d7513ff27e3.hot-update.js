	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			...
			value: function changeVolume(e) {
				...
				console.log((100 - (e.pageY - el.offsetTop)) / 100);

				this.setState(function () {
					return {
						volume: (100 - (e.pageY - el.offsetTop)) / 100
					};
				});
			}
		}, {
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									...
									_react2['default'].createElement('div', { style: { height: this.state.volume * 100 + '%' }, className: 'spliter' })
								)
							)
						)
					)
