				...
				if (this.state.music !== []) {
					music = _react2['default'].createElement(
						...
						this.state.music.map(function (t) {
							...
							return _react2['default'].createElement(_materialUi.ListItem, { primaryText: t.title, secondaryText: t.artist[0], secondaryTextLines: 1, onClick: selectTrack.bind(_this2) });
						})
					);
				}
