...
/******/ 	var hotCurrentHash = "3090608638d2a43976a2"; // eslint-disable-line no-unused-vars
	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
	      ...
	      return {
			...
			key: 'disableSelect',
			value: function disableSelect(e) {
				e.preventDefault();
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ id: 'player-timeline', onClick: this.setTime.bind(this) },
							_react2['default'].createElement(
								'div',
								{ id: 'player-time', style: { width: this.state.time + '%' } },
								_react2['default'].createElement(
									'div',
									{ id: 'current-time', onMouseDown: this.disableSelect },
									this.getCurrentTime()
								)
							)
						),
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								'span',
								{ className: 'btn', id: 'volume', onMouseLeave: this.changeVolumeStop.bind(this) },
								_react2['default'].createElement(
									'span',
									{ id: 'volume-level',
...
/***/ function(module, exports) {
	...
	module.exports = "data:image/png;base64,"
