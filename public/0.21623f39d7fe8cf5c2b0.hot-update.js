	...
	var Element = (function (_React$Component) {
		...
		_createClass(Element, [{
			...
			value: function changeVolume(e) {
				console.log(e.offsetTop, e.target.offsetHeight);
			}
		}, {
			key: 'render',
						...
						_react2['default'].createElement(
							...
							_react2['default'].createElement(
								...
								_react2['default'].createElement(
									'span',
									{ id: 'volume-level' },
									_react2['default'].createElement('div', { style: { height: this.state.volume * 100 + '%' }, onClick: this.changeVolume.bind(this), className: 'spliter' })
								)
							)
						)
					)
