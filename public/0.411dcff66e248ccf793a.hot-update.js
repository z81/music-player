				...
				if (this.state.music !== []) {
					music = _react2['default'].createElement(
						...
						this.state.music.map(function (t) {
							...
							return _react2['default'].createElement(_materialUi.ListItem, { primaryText: t.title, secondaryText: t.artist[0], secondaryTextLines: 2, onTouchStart: selectTrack.bind(_this2) });
						})
					);
				}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'div',
							{ id: 'player-controls' },
							_react2['default'].createElement('audio', { id: 'audio', src: this.state.audio }),
