				...
				if (this.state.music !== []) {
					music = _react2['default'].createElement(
						...
						this.state.music.map(function (t, i) {
							var color = _materialUi2['default'].Styles.Colors.green600;
							...
							return _react2['default'].createElement(_materialUi.ListItem, { color: color, primaryText: t.title, secondaryText: t.artist[0], secondaryTextLines: 1, onClick: selectTrack });
						})
					);
				}
