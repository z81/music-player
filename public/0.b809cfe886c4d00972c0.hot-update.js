			...
			value: function componentDidMount() {
				...
				setInterval(function () {
					_this.setState(function () {
						console.log(Math.round(audio.currentTime / audio.duration * 10) / 10 + '%');
						return {
							time: Math.round(audio.currentTime / audio.duration * 10) / 10 + '%'
						};
					});
				}, 1000);
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement(
							'span',
							null,
							_react2['default'].createElement('div', { id: 'player-time', style: { width: this.state.time }, onClick: this.setTime.bind(this) })
						),
						_react2['default'].createElement(
							'div',
							{ id: 'player-controls' },
